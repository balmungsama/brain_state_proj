...
fslmeants -i $SUBJ_DIR/task_data/preproc/mt_$COND -m $PREPROC/mask_vent_2mm.nii.gz -o $SUBJ_DIR/nuisance/$COND'_t_vent.txt'
fslmeants -i $SUBJ_DIR/task_data/preproc/mt_$COND -m $PREPROC/mask_wm_2mm.nii.gz -o $SUBJ_DIR/nuisance/$COND'_t_wm.txt'
