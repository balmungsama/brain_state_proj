...
fnirt --ref=$TEMPLATE --in=$SUBJ_DIR/anatom/Mprage.nii.gz --aff=$SUBJ_DIR/anatom/mats/aff_str2std.mat --iout=$SUBJ_DIR/anatom/nl_Mprage --cout=$SUBJ_DIR/anatom/cout_nl_brain_Mprage # FNIRT strct to std
bet $SUBJ_DIR/anatom/nl_Mprage $SUBJ_DIR/anatom/nl_brain_Mprage -R
echo '       		+ Creating binary mask from non-linearly warped image...'
fslmaths $SUBJ_DIR/anatom/nl_brain_Mprage -thr 1 -bin $SUBJ_DIR/anatom/bin_nl_brain_Mprage
...
3dresample -dxyz $vox_dim -input $SUBJ_DIR/anatom/bin_nl_brain_Mprage.nii* -rmode 'Linear' -prefix $SUBJ_DIR/anatom/dbin_nl_brain_Mprage
3dAFNItoNIFTI -prefix $SUBJ_DIR/anatom/dbin_nl_brain_Mprage  $SUBJ_DIR/anatom/dbin_nl_brain_Mprage+tlrc
